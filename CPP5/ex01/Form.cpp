...
Form::Form() : _name("DefaultForm"), _signed(false), _signed_grade(150), _exec_grade(150)
{
	std::cout << "\033[2m" << "Form default constructor called" << "\033[0m" << std::endl;
}

Form::Form(std::string name) : _name(name), _signed(false), _signed_grade(150), _exec_grade(150)
{
	std::cout << "\033[2m" << "Form constructor called" << "\033[0m" << std::endl;
}

Form::Form(std::string name, int signed_grade) : _name(name), _signed(false), _signed_grade(signed_grade), _exec_grade(150)
{
	std::cout << "\033[2m" << "Form constructor called" << "\033[0m" << std::endl;
	if (signed_grade < 1)
...
Form::Form(std::string name, int signed_grade, int exec_grade) : _name(name), _signed(false), _signed_grade(signed_grade), _exec_grade(exec_grade)
{
	std::cout << "\033[2m" << "Form constructor called" << "\033[0m" << std::endl;
	if (signed_grade < 1)
		throw	Form::GradeTooHighException();
